    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-background">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-primary rounded-2xl mb-4">
            <svg className="w-10 h-10 text-white" viewBox="0 0 24 24" fill="currentColor">
              ...
              <ellipse cx="12" cy="11" rx="5" ry="7" fill="rgba(255,255,255,0.2)" />
            </svg>
          </div>
          <h1 className="text-2xl font-bold text-gray-900">Sunjin Egg on</h1>
        ...
        <div className="p-3 bg-red-50 border border-red-200 rounded-xl text-sm text-red-700 mb-4">
          ...
          <p className="text-red-500 mt-0.5">@sunjin.com 이메일 주소만 사용 가능합니다.</p>
        </div>
